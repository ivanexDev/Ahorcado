...
window.onload = function(){
  ...
  document.getElementById("colgado").innerHTML = `<img src="img/colgado00.jpg" alt="colgado"></img>`;
...
function colgando(){
  document.getElementById("colgado").innerHTML = `<img src="img/colgado0${errorGlobal}.jpg" alt="colgado"></img>`;
}
  ...
  let errores = 0;
    while (contador < palabraArray.length){
        ...
        if(errores == palabraArray.length){
          errorGlobal++
          document.getElementById("errores").innerHTML = "Llevas " +errorGlobal + " Errores";
          colgando();
        }
      contador++
    }
